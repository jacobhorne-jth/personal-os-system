      ...
      <div className="grid gap-4 p-4 sm:p-5 xl:grid-cols-[1fr_520px] xl:items-end">
        ...
        <div className="grid grid-cols-3 gap-2">
          {stats.map((stat) => {
            ...
            return (
              <Link key={stat.label} href={stat.label === "events" ? "/calendar" : stat.label === "tasks" ? "/responsibilities" : "/weekly-review"} className="rounded-xl border border-line bg-paper p-3.5 transition hover:border-blue/30 hover:bg-panel hover:shadow-glow">
